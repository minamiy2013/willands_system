...
$site_top = "http://www.yahoo.co.jp/";/*-----------------------要変更-------------------------------*/
...
$Referer_check_domain = "php-factory.net";/*-----------------------要変更-------------------------------*/


//---------------------- 任意設定　以下は必要に応じて設定してください ------------------------

// このPHPファイルの名前 ※ファイル名を変更した場合は必ずここも変更してください。
$file_name ="exp_request_check.php";
...
$eles = array('name', 'hurigana', 'postal', 'prefecture', 'address', 'phone', 'email', 'message');/*-----------------------要変更-------------------------------*/
...
ウィランズパソコンスクール
〒542-0086 
大阪府大阪市中央区西心斎橋２丁目９番２８号　ミナックス東急プラザ７F
TEL：06-6125-5630
E-mail:xxxx@xxxx.com/*-----------------------要変更-------------------------------*/
